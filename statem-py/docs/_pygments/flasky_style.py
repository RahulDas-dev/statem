"""Pygments style used for code-highlighting, vendored (verbatim) from the Requests project's
docs (`docs/_themes/flask_theme_support.py` in psf/requests, MIT-licensed) -- the same style
`requests.readthedocs.io` uses, originally based on the "tango" style.
"""
